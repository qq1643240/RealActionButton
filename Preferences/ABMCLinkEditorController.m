...
- (void)viewDidLoad {
    ...
    CFPropertyListRef raw=CFPreferencesCopyValue(storageKey,(__bridge CFStringRef)ABMCLinkDomain,kCFPreferencesCurrentUser,kCFPreferencesAnyHost);
